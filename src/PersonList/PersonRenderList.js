...
import PersonRenderList from './PersonList/PersonRenderList.js'



class PersonRenderList extends Component {
  state={
    persons:[
      {id: 'id1',name: 'Zana', age: 22},
      {id: 'id2',name: 'Blerta', age: 29},
    ],
    showPersons: false
  }
...
export default PersonRenderList;